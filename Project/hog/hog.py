...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    temp_score = boar_brawl(score, opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    temp_score = score + boar_brawl(score, opponent_score)
    sus_score = sus_points(temp_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    If the score is close to the goal, it will play more conservatively.
    """
    # BEGIN PROBLEM 12
    if score + boar_brawl(score, opponent_score) >= GOAL:
        return 0
    if sus_strategy(score, opponent_score, threshold=10, num_rolls=4) == 0:
        return 0
    if boar_strategy(score, opponent_score, threshold=8, num_rolls=4) == 0:
        return 0
